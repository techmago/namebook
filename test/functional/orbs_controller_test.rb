...
class OrbsControllerTest < ActionController::TestCase
  ...
  test "should create orb" do
    assert_difference('Orb.count') do
      post :create, orb: { book_id: @orb.book_id, descr: @orb.descr, id: @orb.id, nome: @orb.nome, orb_type_id: @orb.orb_type_id, orbt: @orb.orbt }
    end
  ...
  test "should update orb" do
    put :update, id: @orb, orb: { book_id: @orb.book_id, descr: @orb.descr, id: @orb.id, nome: @orb.nome, orb_type_id: @orb.orb_type_id, orbt: @orb.orbt }
    assert_redirected_to orb_path(assigns(:orb))
  end
