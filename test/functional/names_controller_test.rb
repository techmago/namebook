...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { descr: @name.descr, family_id: @name.family_id, nome: @name.nome, race_id: @name.race_id }
    end
  ...
  test "should update name" do
    put :update, id: @name, name: { descr: @name.descr, family_id: @name.family_id, nome: @name.nome, race_id: @name.race_id }
    assert_redirected_to name_path(assigns(:name))
  end
